                ...
                if(today!=='Vendredi'){
                    if(today!=='Samedi'){
                        if(today!=='Dimanche'){
                            ...
                            const tomorrow= 'Lundi';
                            console.log(`Demain on est ${tomorrow}`);
                        }
                    }
                    else{
                        const tomorrow= 'Dimanche';
                        console.log(`Demain on est ${tomorrow}`);
                    }
                }
                else{
                    const tomorrow= 'Samedi';
                    console.log(`Demain on est ${tomorrow}`);
                }
            }
            else{
                const tomorrow= 'Vendredi';
                console.log(`Demain on est ${tomorrow}`);
            }
        }
        else{
            const tomorrow= 'Jeudi';
            console.log(`Demain on est ${tomorrow}`);
        }
    }
    else{
        const tomorrow ='Mercredi';
        console.log(`Demain on est ${tomorrow}`);
    }
}
else{
        const tomorrow = 'Mardi';
        console.log(`Demain on est ${tomorrow}`);
    }
