...
if(1){
    console.log("Je suis dans un bloc d'instructions soumis a une condition qui est toujours vraie,je vais donc toujours m'afficher");
}
// Et l'inverse :
...
const nbr = parseInt(prompt("Entrez un nombre"));
...
let hello=null;
hello=prompt("Bonjour");
if(hello === 'Bonjour' || hello === 'bonjour' || hello === 'BONJOUR'){
...
if(civilStatus==='married'){
    ...
    console.log("John va,on l'espère,bientot se marier :)")
}
civilStatus='married'
if(civilStatus==='married'){
    console.log("John est marié !")
...
const heightJohn = 1.69; // en m
const weightJohn = 78; // en kg

const heightMark = 1.95; // en m
const weightMark = 92; // en kg

const BMIJohn=weightJohn/Math.pow(heightJohn,2);
const BMIMark=weightMark/Math.pow(heightMark,2);
...
const number1=parseInt(prompt("Entrez un nombre"));
